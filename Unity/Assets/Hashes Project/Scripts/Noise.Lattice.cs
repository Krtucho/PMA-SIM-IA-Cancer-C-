...
public static partial class Noise
{
	...
	public struct Lattice1D<L,G> : INoise where L : struct, ILattice 
	...
	public struct Lattice2D<L,G> : INoise where L : struct, ILattice
		where G : struct, IGradient
	{
	...
	public struct Lattice3D<L,G> : INoise where L : struct, ILattice
		where G : struct, IGradient
	{
